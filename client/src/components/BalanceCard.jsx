...
const BalanceCard = ({totalRevenue,todayRevenue}) => {
  return (
    <div
    ...
    >
      ...
      <p className="text-[8.533333vw] font-bold mt-[1.333333vw]">₹{totalRevenue || 0}</p>
      <div className="flex justify-between items-center mt-[2vw]">
        <p className="text-[3.733333vw]">Today Revenue</p>
        <p className="text-[5.333333vw] font-bold">₹{todayRevenue || 0}</p>
      </div>
    </div>
  );
};
